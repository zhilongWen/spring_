package com.at.yuntai.government.controller;

import com.at.yuntai.government.bean.GovernmentDetail;
import com.at.yuntai.scheduler.bean.MonitorDetail;
    ...
    public Result<List<GovernmentDetail>> getHiveMetadataScore() {
        try {
            ...
            var connection = DriverManager.getConnection(
                    "jdbc:mysql://hadoop102:3306/yuntai?useSSL=false",
                    "root",
                    "root"
            );
